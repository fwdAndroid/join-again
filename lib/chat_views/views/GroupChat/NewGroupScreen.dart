      ...
      appBar: appBarWidget(
        ...
        titleWidget: widget.isAddParticipant
            ...
            : Column(
                ...
                children: [
                  Text('lblCreateGroup', style: boldTextStyle(color: Colors.white, size: 18, letterSpacing: 0.5)),
                  4.height,
                  Text('lblAddparticipants', style: secondaryTextStyle(color: Colors.white, letterSpacing: 0.5))
                ],
              ),
        actions: [
          AnimatedContainer(
