          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  if (widget.isGroup && userModel.name != null && !widget.data!.isMe.validate()) Text(userModel.name.validate(), style: boldTextStyle(size: 12, color: Colors.white)).paddingAll(1),
