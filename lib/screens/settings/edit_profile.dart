                              ...
                              InkWell(
                                ...
                                child: _image != null
                                    ...
                                    : Container(
                                        ...
                                        child: Center(child: CircleAvatar(radius: 60, backgroundImage: NetworkImage(image))),
                                      ),
                              ),
                              Container(
                                  ...
                                  child: Text(
                                    "Name",
                                    style: TextStyle(
                                        fontFamily: "ProximaNova", fontWeight: FontWeight.w400, fontSize: 16, color: Color(0xff736F7F)),
                                  )),
                              Container(
                                width: 315,
                                height: 46,
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                      ...
                                      focusedBorder: OutlineInputBorder(
                                          borderRadius: BorderRadius.circular(6), borderSide: BorderSide(color: Color(0xffEBF1F3))),
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                ...
                                style: TextStyle(fontFamily: "ProximaNova", fontWeight: FontWeight.w400, fontSize: 16, color: Colors.black),
                              ),
                              Spacer(),
                              Text(
                                "2/5",
                        ...
                        Center(
                          child: GroupButton(
                            isRadio: false,
                            buttons: ["Football", "Golf", "Yoga", "Cricket", "Football", "Hockey"],
                          ),
                        ),
                        Container(
                          margin: EdgeInsets.only(top: 10),
                        ...
                        Center(
                          child: GroupButton(
                            isRadio: false,
                            buttons: ["Networking", "Study Groups", "Languages", "Cricket", "Football", "Hockey"],
                          ),
                        ),
                        Container(
                          margin: EdgeInsets.only(top: 10),
                        ...
                        Center(
                          child: GroupButton(
                            isRadio: false,
                            buttons: ["Museum", "Exbition", "Languages", "Cricket", "Football", "Hockey"],
                          ),
                        )
                      ],
                    ),
