...
import '../../chat_views/views/GroupChat/GroupChatRoom.dart';
import '../../chat_views/views/components/LastMessageContainer.dart';
import '../../chat_views/views/models/ContactModel.dart';
import '../../chat_views/views/models/UserModel.dart';
import '../../chat_views/views/utils/Appwidgets.dart';
          ...
          child: Column(
            children: [
              StreamBuilder<QuerySnapshot>(
                stream: chatMessageService.fetchContacts(userId: userID),
                          ...
                          Row(
                            ...
                            children: [
                              LastMessageContainer(
                                stream: chatMessageService.fetchLastMessageBetween(senderId: userID, receiverId: contact.uid!),
                              ),
                            ],
                          ),
                        ],
        ...
        return snap.data != null
            ? ListView.separated(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  var data;
                  members.map((e) {
                    if (e.contains(userID) && contact.groupRefUrl == snap.data![index]['id']) {
