...
class IntelacutualActivities extends StatefulWidget {
  const IntelacutualActivities({super.key});

  @override
  State<IntelacutualActivities> createState() => _IntelacutualActivitiesState();
}

class _IntelacutualActivitiesState extends State<IntelacutualActivities> {
  ...
  Future<void> fetchLocationData() async {
    QuerySnapshot querySnapshot =
        await FirebaseFirestore.instance.collection('activity').where("activity", isEqualTo: "Interllectual Activities").get();
    setState(() {
